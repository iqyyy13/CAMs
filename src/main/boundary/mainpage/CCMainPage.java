...
public class CCMainPage 
{
    ...
    public static void ccMainPage(User user) 
    {
        if (user instanceof Student student) 
        {
            ...
            System.out.println("\t9. View own enquiry");
            System.out.println("\t10. Edit enquiry");
            System.out.println("\t11. View all pending enquiries");
            System.out.println("\t12. Reply enquiry");
            System.out.println("\t13. Delete enquiry");
            ...
            System.out.println("\t18. Generate report of students attending each camp");
            ...
            try {
                switch (choice) {
                    ...
                    case 8 -> EnquiryManager.new_enquiry(student.getRegisteredCampIDs(), student.getID());
                    case 9 -> EnquiryManager.view_enquiry(student.getID());
                    case 10 -> EnquiryManager.edit_enquiry(null);
                    case 11 -> EnquiryManager.view_CC_pending_enquiry(student.getCCId());
                    case 12 -> replyEnquiry(student);
    ...
    */
    ...
    private static void replyEnquiry(Student student)
    {
        student.incrementPoint();
        try
        {
            StudentDatabase.getInstance().update(student);
            EnquiryManager.reply_enquiry(null);
        } catch (PageBackException e)
        {
            CCMainPage.ccMainPage(student);
        } catch (UserErrorException e)
